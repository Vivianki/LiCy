...
%	\end{figure}
	...
	A seguir serão discorridas as implicações da implementação da norma IEEE 802.15.7 em um escopo de hardware. Estarão divididos em duas partes: analógica e digital. Será aplicada uma abordagem \textit{top-down}, começando pela necessidade de transmitir, receber e converter os dados digitais em sinais luminosos, ou até analógicos.
	...
	Para cada um desses componentes deve haver um minucioso estudo sobre suas características electro-eletrônicas, pois existem muitas restrições que devem ser levadas em conta com a frequência de operação $F_{op}$ = 200 kHz, como:
	...
	O LED deverá ser capaz de enviar sinais luminosos oscilantes a uma frequência não perceptível ao olho de 200kHz especificada na norma.
