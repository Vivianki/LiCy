...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/uart_tb/simulation/submodules/verbosity_pkg.sv"                                                          -work altera_common_sv_packages                     
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/uart_tb/simulation/submodules/avalon_mm_pkg.sv"                                                          -work altera_common_sv_packages                     
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/uart_tb/simulation/submodules/avalon_utilities_pkg.sv"                                                   -work altera_common_sv_packages                     
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/uart_tb/simulation/submodules/aldec/altera_merlin_slave_translator.sv"      -l altera_common_sv_packages -work uart_inst_avalon_rs232_slave_translator       
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/uart_tb/simulation/submodules/altera_merlin_master_translator.sv"           -l altera_common_sv_packages -work uart_inst_avalon_rs232_slave_bfm_m0_translator
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/uart_tb/simulation/submodules/altera_avalon_interrupt_sink.sv"              -l altera_common_sv_packages -work uart_inst_interrupt_bfm                       
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/uart_tb/simulation/submodules/altera_avalon_interrupt_sink_vhdl_wrapper.sv" -l altera_common_sv_packages -work uart_inst_interrupt_bfm                       
  ...
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/uart_tb/simulation/submodules/altera_avalon_mm_master_bfm.sv"               -l altera_common_sv_packages -work uart_inst_avalon_rs232_slave_bfm              
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/uart_tb/simulation/submodules/altera_avalon_mm_master_bfm_vhdl_wrapper.sv"  -l altera_common_sv_packages -work uart_inst_avalon_rs232_slave_bfm              
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L altera_common_sv_packages -L uart_inst_avalon_rs232_slave_translator -L uart_inst_avalon_rs232_slave_bfm_m0_translator -L irq_mapper -L mm_interconnect_0 -L uart_inst_reset_bfm -L uart_inst_interrupt_bfm -L uart_inst_external_interface_bfm -L uart_inst_clk_bfm -L uart_inst_avalon_rs232_slave_bfm -L uart_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L altera_common_sv_packages -L uart_inst_avalon_rs232_slave_translator -L uart_inst_avalon_rs232_slave_bfm_m0_translator -L irq_mapper -L mm_interconnect_0 -L uart_inst_reset_bfm -L uart_inst_interrupt_bfm -L uart_inst_external_interface_bfm -L uart_inst_clk_bfm -L uart_inst_avalon_rs232_slave_bfm -L uart_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive $TOP_LEVEL_NAME
}
