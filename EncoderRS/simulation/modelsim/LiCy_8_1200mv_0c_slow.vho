...
-- locked	=>  Location: PIN_Y4,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \inst1|altpll_component|auto_generated|locked~combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \inst1|altpll_component|auto_generated|locked~combout\,
	devoe => ww_devoe,
	o => ww_locked);
...
\inst1|altpll_component|auto_generated|pll_lock_sync~feeder\ : cycloneive_lcell_comb
-- Equation(s):
...
\inst1|altpll_component|auto_generated|locked\ : cycloneive_lcell_comb
-- Equation(s):
